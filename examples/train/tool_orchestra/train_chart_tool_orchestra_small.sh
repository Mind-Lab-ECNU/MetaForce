...
export SWANLAB_LOG_DIR=./swanlog_lf

ROOT_DIR="$(pwd)"

train_data=[${ROOT_DIR}/data_duo_final/ChartQA_2000/train_final_09.parquet,${ROOT_DIR}/data_duo_final/figureqa_2000/train_final_09.parquet]
val_data=[${ROOT_DIR}/data_duo_final/ChartQA_2000/train_final_01.parquet,${ROOT_DIR}/data_duo_final/figureqa_2000/train_final_01.parquet]
...
PYTHONUNBUFFERED=1 python3 -m verl_tool.trainer.main_ppo \
    ...
    trainer.default_local_dir=$(pwd)/verl_step_records/checkpoint/$run_name-debug \
    trainer.rollout_data_dir=$(pwd)/verl_step_records//train/$run_name-debug \
    trainer.validation_data_dir=$(pwd)/verl_step_records/val/$run_name-debug \
