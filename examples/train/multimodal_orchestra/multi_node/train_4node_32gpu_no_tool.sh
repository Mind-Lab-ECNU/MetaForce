...
#   NODE_RANK=0 TOOL_SERVER_URL=http://192.168.1.50:5000/get_observation bash train_4node_32gpu_no_tool.sh
#
#   # 在 worker 节点:
#   NODE_RANK=1 MASTER_ADDR=192.168.1.100 TOOL_SERVER_URL=http://192.168.1.50:5000/get_observation bash train_4node_32gpu_no_tool.sh
# =============================================================================
