...
# =============================================================================
# 此脚本假设工具服务器已经提前启动好，只负责启动 Ray 集群和训练任务
#
# 使用场景:
#   - 工具服务器在单独的节点/容器中运行
#   - 多个训练任务共享同一个工具服务器
...
#   NODE_RANK=0 TOOL_SERVER_URL=http://192.168.1.50:5000/get_observation bash train_2node_16gpu_no_tool.sh
#
#   # 在 worker 节点:
#   NODE_RANK=1 MASTER_ADDR=192.168.1.100 TOOL_SERVER_URL=http://192.168.1.50:5000/get_observation bash train_2node_16gpu_no_tool.sh
# =============================================================================
...
# 训练数据配置 (20个数据集)
# =============================================================================
train_data="${DATA_ROOT}/train_merge_v2/train_merge_v2.parquet"
