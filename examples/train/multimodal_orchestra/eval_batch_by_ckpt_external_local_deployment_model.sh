...
EXP_NAMES_INPUT="internvl-38b-clevr-math"
MODEL_BASE_URL_INPUT=""
MODEL_BASE_URLS_INPUT="https://ai-notebook-inspire.sii.edu.cn/ws-9dcc0e1f-80a4-4af2-bc2f-0e352e7b17e6/project-b795c114-135a-40db-b3d0-19b60f25237b/user-c6264b38-46a1-4bb6-a3a7-1db39453f6f8/vscode/34c6ec87-4965-4fe3-9f53-1a615e360764/d3734501-dd20-4327-95a2-c73ed49b4c1e/proxy/30043/v1"
MODEL_NAMES_INPUT="InternVL3.5-38B-Instruct"
...
VAL_DATA_PATH_INPUT='/inspire/hdd/project/ai4education/public/wsa_1.0/verltools/verl_m/data_multi_category/data/test_merge_v4_clevr_math_tool_id/test_ood_merge_v4_clevr_math_tool_id.parquet'
...
BATCH_LOG_DIR="${BATCH_LOG_DIR:-${BATCH_LOG_DIR_INPUT:-$(pwd)/logs/multimodal_orchestra_eval_batch_external_model}}"
