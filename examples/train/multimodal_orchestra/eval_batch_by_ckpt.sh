...
# CHECKPOINT_PATHS_INPUT='/inspire/hdd/project/ai4education/zhouaimin-p-zhouaimin/zc/verltools/model/AdaReasoner-7B-Randomized'
# CHECKPOINT_PATHS_INPUT=/inspire/hdd/project/ai4education/zhouaimin-p-zhouaimin/zc/verltools/model/ZwZ-8B
# CHECKPOINT_PATHS_INPUT=/inspire/hdd/project/ai4education/zhouaimin-p-zhouaimin/zc/verltools/model/TikArt-8B
# CHECKPOINT_PATHS_INPUT=/inspire/hdd/project/ai4education/zhouaimin-p-zhouaimin/zc/verltools/model/Qwen3-VL-235B-A22B-Instruct
# CHECKPOINT_PATHS_INPUT=/inspire/hdd/project/ai4education/zhouaimin-p-zhouaimin/zc/verltools/model/PyVision-Image-7B-RL
# CHECKPOINT_PATHS_INPUT=/inspire/hdd/project/ai4education/zhouaimin-p-zhouaimin/zc/verltools/model/LLaVA-OneVision-1.5-8B-RL
# CHECKPOINT_PATHS_INPUT=/inspire/hdd/project/ai4education/zhouaimin-p-zhouaimin/zc/verltools/model/Qwen2.5-VL-7B-Instruct
# CHECKPOINT_PATHS_INPUT=/inspire/hdd/project/ai4education/public/wsa_1.0/verltools/verl_m/verl_step_records/checkpoint/train/20260410_200524_ablation_no_skill_reward_multimodal_orchestra_ablate_latency_format_skill-fsdp2-agent-_inspire_hdd_project_ai4education_public_models_qwen_qwen3-vl-8b-instruct-skill-reward-grpo-lr1e-6-c_and_f_s-0-cu_s-20-l_s-86-t_s-86-kl_l-0.002
# CHECKPOINT_PATHS_INPUT=/inspire/hdd/project/ai4education/public/wsa_1.0/verltools/verl_m/verl_step_records/checkpoint/train/20260412_110712_ablation_no_format_reward_multimodal_orchestra_ablate_latency_format_skill-fsdp2-agent-_inspire_hdd_project_ai4education_public_models_qwen_qwen3-vl-8b-instruct-skill-reward-grpo-lr1e-6-c_and_f_s-0-cu_s-20-l_s-86-t_s-86-kl_l-0.002
CHECKPOINT_PATHS_INPUT=/inspire/hdd/project/ai4education/public/wsa_1.0/verltools/verl_m/verl_step_records/checkpoint/train/20260412_234455_ablation_qwen25_7b_multimodal_orchestra_ablate_latency_format_skill-skill-reward-c_and_f_s-0-cu_s-20-l_s-86-t_s-86-kl_l-0.002

# TARGET_STEPS_INPUT="40"
# TARGET_STEPS_INPUT="86"
TARGET_STEPS_INPUT="130"

# EXP_NAMES_INPUT="r1-onevision-7b-rl"
# EXP_NAMES_INPUT="exp15_step40_from_13_step80-v7-data"
# EXP_NAMES_INPUT="vtool-qwen2.5-7b"
# EXP_NAMES_INPUT="pixelreasoner-rl-v7-data"
# EXP_NAMES_INPUT="DeepEyesV2_7B"
# EXP_NAMES_INPUT="base"
# EXP_NAMES_INPUT="r1-vl-7b"
# EXP_NAMES_INPUT="adareasoner-7b-v7-data"
# EXP_NAMES_INPUT="zwz-8b-v7-data"
# EXP_NAMES_INPUT="tikart-8b-v7-data"
# EXP_NAMES_INPUT="qwen3-235b-v7-data"
# EXP_NAMES_INPUT="pyvision-image-7b-v7-data"
# EXP_NAMES_INPUT="llava-onevision-8b-v7-data"
# EXP_NAMES_INPUT="ablation_no_skill_reward-v8-data"
# EXP_NAMES_INPUT="ablation_no_format_reward-v8-data"
EXP_NAMES_INPUT="ablation_qwen_25_7b-v8-data"
...
VAL_DATA_PATH='/inspire/hdd/project/ai4education/public/wsa_1.0/verltools/verl_m/data_multi_category/data/test_merge_v8_tool_id/test_merge_v8_tool_id.parquet'
...
BATCH_LOG_DIR="${BATCH_LOG_DIR:-$(pwd)/logs/multimodal_orchestra_eval_batch_ablation}"
