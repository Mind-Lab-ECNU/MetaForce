#!/usr/bin/env bash
# =============================================================================
# Multimodal Orchestra Single-Node Eval Wrapper with Retry (8 GPUs)
# =============================================================================
# 启动方式:
#
...
RETRY_LOG_DIR=${RETRY_LOG_DIR:-"$(pwd)/logs/multimodal_orchestra_single_node/retry"}

mkdir -p "$RETRY_LOG_DIR"

BUNDLED_SCRIPT="${SCRIPT_DIR}/eval_8gpu.sh"
EXTERNAL_SCRIPT="${SCRIPT_DIR}/eval_8gpu_no_tool.sh"
...
echo "=========================================="
echo "Single-Node Eval Retry Wrapper"
...
while true; do
    ...
    attempt_log="${RETRY_LOG_DIR}/single_eval_attempt${attempt}_${attempt_ts}.log"
