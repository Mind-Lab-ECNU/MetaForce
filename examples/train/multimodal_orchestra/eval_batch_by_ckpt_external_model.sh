...
EXP_NAMES_INPUT="gemini-2.5-flash-clevr-math"
MODEL_BASE_URL_INPUT=""
...
MODEL_NAMES_INPUT="gemini-2.5-flash"
...
BATCH_LOG_DIR="${BATCH_LOG_DIR:-${BATCH_LOG_DIR_INPUT:-$(pwd)/logs/multimodal_orchestra_eval_batch_external_model_closed}}"
