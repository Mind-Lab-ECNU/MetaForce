...
CHECKPOINT_PATHS="/inspire/hdd/project/ai4education/zhouaimin-p-zhouaimin/zc/verltools/model/Qwen2.5-VL-7B-Instruct"
...
EXP_NAMES="qwen2.5-7b-clevr_math"
...
EVAL_SCRIPT="${EVAL_SCRIPT:-${SCRIPT_DIR}/single_node/eval_8gpu_id.sh}"
...
VAL_DATA_PATH='/inspire/hdd/project/ai4education/public/wsa_1.0/verltools/verl_m/data_multi_category/data/test_merge_v4_clevr_math_tool_id/test_ood_merge_v4_clevr_math_tool_id.parquet'
...
BATCH_LOG_DIR="${BATCH_LOG_DIR:-$(pwd)/logs/multimodal_orchestra_eval_batch_clevr_math_tool_id}"
