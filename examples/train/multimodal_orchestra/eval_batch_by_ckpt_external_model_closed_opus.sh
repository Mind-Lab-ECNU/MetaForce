...
EXP_NAMES_INPUT="claude-opus-4-6-mathvista"
# EXP_NAMES_INPUT="gpt-5.4-v7-data"
MODEL_BASE_URL_INPUT=""
...
MODEL_NAMES_INPUT="claude-opus-4-6"
...
VAL_DATA_PATH_INPUT='/inspire/hdd/project/ai4education/public/wsa_1.0/verltools/verl_m/data_multi_category/data/test_merge_v3_ai2d_mathvista_tool_id/OOD/MathVista_test_OOD/test.parquet'
...
BATCH_LOG_DIR="${BATCH_LOG_DIR:-${BATCH_LOG_DIR_INPUT:-$(pwd)/logs/multimodal_orchestra_eval_batch_external_model_opus_closed}}"
