...
# model_name=/path/to/base_models/qwen2.5-0.5b-wiki
# model_name=/path/to/experiments/wiki/qwen2.5-1.5b-direct_plain-hard
model_name=/path/to/base_models/qwen2.5-3b-1epoch-hard
