...
Reads data with persona and adds enhanced tools, model_mapping, and tool_pricing.
Preserves persona_zh, persona, and pref_vec from input data.
"""
...
def main() -> None:
    ...
    if args.input_dir is None:
        args.input_dir = verl_duo_dir / "data_duo_final" / "figureqa_2000"
    else:
        args.input_dir = Path(args.input_dir)

    if args.output_dir is None:
        args.output_dir = verl_duo_dir / "data_duo_final" / "figureqa_2000"
    else:
    ...
    input_file = args.input_dir / f"{args.split}_with_persona.json"
    ...
    parquet_path = args.output_dir / f"{args.split}_final.parquet"
    ...
    json_path = args.output_dir / f"{args.split}_final.json"
