#!/usr/bin/env python3
"""Merge test_merge_v3 OOD datasets with strict validations and type normalization."""
...
def main() -> None:
    ...
    print("=" * 80)
    print(f"Merge test datasets -> {args.test_merge_dir_name}/test_ood_merge_v3")
    print("=" * 80)
    ...
    out_test_ood_json = (
        ...
        else output_root / "test_ood_merge_v3.json"
    )
