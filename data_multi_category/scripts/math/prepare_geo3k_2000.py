...
"""
Preprocess the Geometry3k dataset to json format with local images.
...
def main() -> None:
    ...
    parser.add_argument("--dataset_path", default="hiyouga/geometry3k")
