#!/usr/bin/env python3
"""
Reuse already processed full ID test datasets and rewrite them under data/test/ID
...
DATASETS = [
    {
        "name": "ChartQA_test_ID",
        "src_dir": DATA_ROOT / "chart" / "ChartQA",
        "src_file": "test.json",
    },
    {
        "name": "ScienceQA_test_ID",
        "src_dir": DATA_ROOT / "science" / "ScienceQA",
        "src_file": "test.json",
    },
]
