#!/usr/bin/env python3
"""
Reuse already processed ID test datasets and rewrite them under data/test/ID
...
OUTPUT_ROOT = DATA_ROOT / "test" / "ID"

DATASETS = [
    {
        "name": "PlotQA_test_ID",
        "src_dir": DATA_ROOT / "chart" / "PlotQA_2000",
        "src_file": "test.json",
    },
    {
        "name": "MapQA_test_ID",
        "src_dir": DATA_ROOT / "geospatial" / "MapQA_2000",
        "src_file": "test.json",
    },
    {
        "name": "geometry3k_test_ID",
        "src_dir": DATA_ROOT / "math" / "geometry3k_2000",
        "src_file": "test.json",
    },
    {
        "name": "OCRVQA_test_ID",
        "src_dir": DATA_ROOT / "add" / "ocr" / "OCRVQA_2000",
        "src_file": "test.json",
    },
]
