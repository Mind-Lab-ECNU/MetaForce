#!/usr/bin/env python3
"""
Reuse already processed OOD test datasets and rewrite them under data/test/OOD
...
DATASETS = [
    {
        "name": "ICON-QA_test_OOD",
        "src_dir": DATA_ROOT / "diagram" / "ICON-QA_2000",
        "src_file": "test.json",
    },
    {
        "name": "MathVista_test_OOD",
        "src_dir": DATA_ROOT / "math" / "MathVista_2000",
        "src_file": "testmini.json",
    },
    {
        "name": "unigeo_test_OOD",
        "src_dir": DATA_ROOT / "math" / "unigeo_calculation_2000",
        "src_file": "test.json",
    },
]
