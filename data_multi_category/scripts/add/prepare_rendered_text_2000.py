...
"""
Preprocess the RenderedText dataset to parquet format with local images.
...
def main() -> None:
    ...
    parser.add_argument("--dataset_config", default="rendered_text")
    ...
    dataset_name = "RenderedText_2000"
