...
"""
Preprocess the RoBUTWikiSQL dataset to parquet format with local images.
...
def main() -> None:
    ...
    parser.add_argument("--dataset_config", default="robut_wikisql")
    ...
    dataset_name = "RoBUTWikiSQL_2000"
