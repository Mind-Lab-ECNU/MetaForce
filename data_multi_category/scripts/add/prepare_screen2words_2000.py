...
"""
Preprocess the Screen2Words dataset to parquet format with local images.
...
def main() -> None:
    ...
    parser.add_argument("--dataset_config", default="screen2words")
    ...
    dataset_name = "Screen2Words_2000"
