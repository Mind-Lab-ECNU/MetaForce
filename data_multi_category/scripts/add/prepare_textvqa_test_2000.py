...
"""
Preprocess the TextVQA dataset to parquet format with local images.
...
def _extract_sample(example: dict) -> tuple[str, str, list, str, dict]:
    ...
    return question, _normalize_answer(answers), image_items, "", {}


def main() -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument("--dataset_path", default="lmms-lab/textvqa")
