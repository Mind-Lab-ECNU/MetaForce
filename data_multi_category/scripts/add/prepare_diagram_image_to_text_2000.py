...
"""
Preprocess the DiagramImageToText dataset to parquet format with local images.
...
def main() -> None:
    ...
    parser.add_argument("--dataset_config", default="diagram_image_to_text")
    ...
    dataset_name = "DiagramImageToText_2000"
