...
"""
Preprocess the LocalizedNarratives dataset to parquet format with local images.
...
def main() -> None:
    ...
    parser.add_argument("--dataset_config", default="localized_narratives")
    parser.add_argument("--output_dir", default="/inspire/hdd/project/ai4education/public/wsa_1.0/verltools/verl_m/data_multi_category/data/add/caption")
