...
"""
Preprocess the A-OKVQA dataset to parquet format with local images.
...
def main() -> None:
    ...
    parser.add_argument("--dataset_path", default="HuggingFaceM4/A-OKVQA")
    parser.add_argument("--output_dir", default="/inspire/hdd/project/ai4education/public/wsa_1.0/verltools/verl_m/data_multi_category/data/general")
    ...
    for split_name, split_dataset in dataset.items():
        ...
        for local_idx, orig_idx in enumerate(sampled_indices):
            ...
            try:
                # Field mapping: question_id, question, image, choices, correct_choice_idx, direct_answers, difficult_direct_answer, rationales
            ...
            if not isinstance(choices, list) or not choices:
                 print(f"Skipping example {orig_idx} due to invalid choices")
                 continue
            
            # Use correct_choice_idx as answer
            answer = str(correct_choice_idx)
            ...
            # Unused fields: direct_answers: direct answers list, difficult_direct_answer: difficult direct answer (bool), rationales: rationales list, correct_choice_idx: correct choice index
            data = {
