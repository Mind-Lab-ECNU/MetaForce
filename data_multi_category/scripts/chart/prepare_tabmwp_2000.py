...
"""
Preprocess the TABMWP dataset to parquet format with local images.
...
def _get_question_answer(example: dict):
    ...
    # TABMWP often has a 'table' field. Should we append it to the question?
...
def main() -> None:
    ...
    parser.add_argument("--dataset_config", default="tabmwp")
    parser.add_argument("--output_dir", default="/inspire/hdd/project/ai4education/public/wsa_1.0/verltools/verl_m/data_multi_category/data/chart")
