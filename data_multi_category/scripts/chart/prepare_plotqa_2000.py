...
"""
Preprocess the PlotQA dataset to parquet format with local images.
...
def _get_question_answer(example: dict):
    ...
    # PlotQA often has answers as list of strings
...
def main() -> None:
    ...
    parser.add_argument("--dataset_config", default="plotqa")
