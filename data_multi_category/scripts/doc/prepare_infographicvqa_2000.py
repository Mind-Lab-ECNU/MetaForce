...
"""
Preprocess the InfographicVQA dataset to parquet format with local images.
...
def _extract_infovqa_qa(example: dict) -> tuple[str, str]:
    """Extract question and answer for InfographicVQA-like schemas."""
...
def main() -> None:
    ...
    parser.add_argument("--dataset_path", default="Ahren09/InfoVQA")
    ...
    dataset_name = "InfographicVQA_2000"
    ...
    for split_name, split_dataset in dataset.items():
        ...
        for local_idx, orig_idx in enumerate(sampled_indices):
            ...
            try:
                question_text, answer = _extract_infovqa_qa(example)
            except Exception as e:
            ...
            # Unused fields: answers: answers list, questionId: question ID
            data = {
