#!/usr/bin/env python3
"""Build OOD test_merge_v2 datasets from existing processed files (pure reuse)."""
...
OOD_REUSE_CONFIG: List[Dict[str, str]] = [
    # {
    #     "output_name": "ChartQA_test_OOD",
    #     "src_rel_dir": "chart/ChartQA",
    #     "src_file": "test.json",
    # },
    {
    ...
    # {
    #     "output_name": "WebSight_test_OOD",
    #     "src_rel_dir": "add/code/WebSight_2000",
    #     "src_file": "train.json",
    # },
    # {
    ...
    # },
    # {
    #     "output_name": "ScienceQA_test_OOD",
    #     "src_rel_dir": "science/ScienceQA",
    #     "src_file": "test.json",
    # },
]
...
def main() -> None:
    ...
    print("=" * 80)
    print("Prepare OOD test_merge_v2 (pure reuse)")
    print("=" * 80)
    ...
    for cfg in OOD_REUSE_CONFIG:
        ...
        if len(valid) > args.threshold:
            reused = stable_sample(valid, args.sample_over_threshold, args.seed)
        else:
            reused = valid
