...
def test_tool_initialization():
    ...
    assert tool.tool_type in {"multimodal_processor_tool", "multimodal_processor_tool_adapt_skill"}
    print("  验证子工具注册...")
...
def test_unichart_call():
    ...
    obs, done, valid = tool.conduct_action("t-008-unichart", action, {"images": [IMAGE_PATH]})
    print(f"  obs={obs}, valid={valid}")
...
def test_deplot_call():
    ...
    obs, done, valid = tool.conduct_action("t-008-deplot", action, {"images": [IMAGE_PATH]})
    print(f"  obs={obs}, valid={valid}")
...
def test_chartmoe_call():
    ...
    obs, done, valid = tool.conduct_action("t-008-chartmoe", action, {"images": [IMAGE_PATH]})
    print(f"  obs={obs}, valid={valid}")
...
def test_step3_call():
    ...
    obs, done, valid = tool.conduct_action("t-008-step3", action, {"images": [IMAGE_PATH]})
    print(f"  obs={obs}, valid={valid}")
