...
def paddle_health_check(server_url: str, timeout: int = 60) -> dict:
    """
    检查 PaddleOCR 服务健康状态

    Args:
        server_url: 服务端地址，如 "http://localhost:30019"
        timeout: 请求超时时间（秒）
...
if __name__ == "__main__":
    # 配置
    SERVER_URL = "https://ai-notebook-inspire.sii.edu.cn/ws-9dcc0e1f-80a4-4af2-bc2f-0e352e7b17e6/project-b795c114-135a-40db-b3d0-19b60f25237b/user-c6264b38-46a1-4bb6-a3a7-1db39453f6f8/vscode/5e251c6d-8e0c-4e8c-be04-4f64e5d8e5eb/cbf73fa3-6fdd-47fa-a3d9-14de85230f07/proxy/30019/"
    IMAGE_PATH = "/inspire/hdd/project/ai4education/zhouaimin-p-zhouaimin/zc/verltools/paddleocr_vl_demo.png"

    print(f"连接服务: {SERVER_URL[:80]}...")
    print("正在检查服务状态...")
    health = paddle_health_check(SERVER_URL)
    print(f"服务状态: {health}")
    ...
    # OCR 识别
    print("\n" + "=" * 50)
    print("开始 OCR 识别（可能需要几分钟）...")
    result = paddle_ocr_file(SERVER_URL, IMAGE_PATH, task="ocr")
    print(result)
