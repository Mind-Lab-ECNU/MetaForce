...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        correct_and_format_only_actor_steps (int): In the first K global steps, actor update only uses
            trajectories where is_correct == 1 and format_reward == 0.5. 0 disables this behavior.
    """
    ...
    correct_and_format_only_actor_steps: int = 0
